...
def read_csv(file_name, dim):
    ...
    t = at_t[:, 6]
    at = at_t[:, 0]*9.8/1000 # doesn't have a time dimension
    return at, t, np.shape(at_t)[0]
...
if __name__ == '__main__':
    ...
    xt, vt, t = double_simps_integral(x0, v0, dim, '2020-11-25 17_24_07.862840_LOG1.csv')
    # plot 1st dimension:
